...
trait AjaxFormTrait {
   ...
   * to the triggering element. When ['#ajax']['element'] is specified,
   * the messages will be shown above it. Otherwise, the status messages
   * will be shown above the whole form.
   * Example:
   * <code>
   ...
   * as a workaround to core bug #2897377. This is done by InlineFormBase.
   *
   * @param array $form
